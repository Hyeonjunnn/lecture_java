...
public class A_arrayList {
    ...
    public void method3(){
        ...
        // 타이틀순으로 리스트를 오름차순으로 정렬 (람다식 사용)
        Collections.sort(musics, (music1, music2) -> music1.getTitle().compareTo(music2.getTitle()));
